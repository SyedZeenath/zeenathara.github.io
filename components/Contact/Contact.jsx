...
export default function Contact() {
  ...
  const linksRef = useScrollReveal({ delay: 180 });
      ...
      <div className={styles.container}>
        ...
        <div ref={ctaRef} className={styles.cta}>
          <h2 className={styles.heading}>
            ...
            <em className={styles.headingAccent}>opportunity.</em>
          </h2>
          <p className={styles.sub}>
            I'm finishing my MSc in August 2026 and actively exploring roles in
            Forward Deployed Engineering, Robotics Perception, and AI Systems —
            across Ireland, the Netherlands, and Europe.
          </p>
        </div>
